...
public class RomanConverterServiceImpl extends RemoteServiceServlet implements
    ...
    public String convertDateYears(String nbr) throws IllegalArgumentException {
        ...
        String pattern = "^(?:(?:31(\\/|-|\\.)(?:0?[13578]|1[02]))\\1|(?:(?:29|30)(\\/|-|\\.)(?:0?[1,3-9]|1[0-2])\\2))(?:(?:1[0-9]|[2-9]\\d)?\\d{2})$|^(?:29(\\/|-|\\.)0?2\\3(?:(?:(?:1[0-9]|[2-9]\\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\\d|2[0-8])(\\/|-|\\.)(?:(?:0?[1-9])|(?:1[0-2]))\\4(?:(?:1[0-9]|[2-9]\\d)?\\d{2})$";

        String format = "yyyy";

        java.text.SimpleDateFormat formater = new java.text.SimpleDateFormat(format);
        java.util.Date date = new java.util.Date();
        Integer dateNow = Integer.parseInt(formater.format(date));
        if (!nbr.matches(pattern) || year > dateNow) {
